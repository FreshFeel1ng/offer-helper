"""HTTP client for offer-helper FastAPI backend."""

import os
from typing import Optional
import httpx

BASE_URL = os.environ.get("OFFERHELPER_API", "http://127.0.0.1:8010")
...
def _post(path: str, json=None, timeout=120):
    try:
        ...
        resp = httpx.Response(503, text="Cannot connect to offer-helper server. Run `offerhelper server --start` first.")
    return resp
